...
$schema = [
    ...
    'export_fields' => [
        ...
        'Category' => [
            ...
            'process_put' => ['fn_exim_set_product_categories', '#key', 'M', '#this', '@category_delimiter', '', '#counter'],
            'multilang'   => true,
        ...
        'Secondary categories' => [
            ...
            'process_put' => ['fn_exim_set_product_categories', '#key', 'A', '#this', '@category_delimiter', '', '#counter'],
            'multilang'   => true,
            'linked'      => false, // this field is not linked during import-export
        ],
        'List price' => [
