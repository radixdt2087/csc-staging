...
return empty($settings[$var]) ? 'N' : $settings[$var];
}
...
{
if (!empty($params['ab__vg_products_with_video']) && $params['ab__vg_products_with_video'] === 'Y') {
...
{
if (Registry::get('addons.ab__video_gallery.enable_microdata') !== 'Y') {
return;
}
