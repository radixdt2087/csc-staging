...
return $feature_id ? $feature_id : db_get_field("SELECT feature_id FROM ?:product_features WHERE status = ?s AND feature_type = 'E' AND company_id = ?i", ObjectStatuses::ACTIVE, fn_get_runtime_company_id());
}
