...
if( $_SERVER['REQUEST_METHOD'] == 'POST' 
	...
	$user_aff = ez_ch::get_ch_data(CH_TYPE_USER, $_SESSION['auth']['user_id']);
	...
	$user_data['charities']['affiliate_id'] = $user_aff 
		? $user_aff 
		: $default;
	$_SESSION['auth']['charities']['affiliate_id'] = $user_data['charities']['affiliate_id'];
