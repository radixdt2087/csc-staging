...
function fn_settings_actions_addons_ab__stickers_cron_key(&$new_value, $old_value)
{
$addon = Registry::get('addons.ab__stickers');
if (isset($addon['cron_key']) && !fn_ab__stickers_is_valid_cron_key($new_value, false)) {
fn_set_notification('W', __('warning'), __('ab__stickers.errors.cron_key', ['[value]' => $new_value]));
$new_value = $old_value;
}
}
