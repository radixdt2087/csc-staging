...
class AmazonOrder extends AmazonOrderCore{
     ...
     * @param array $s [required] <p>Authentication data for the store you want to use.
    ...
    protected function parseXML($xml){
        ...
        if (isset($xml->PaymentMethodDetails)){
            ...
            foreach($xml->PaymentMethodDetails->children() as $payment_detail) {
                $d['PaymentMethodDetails'][] = (string)$payment_detail;
            }
        }
