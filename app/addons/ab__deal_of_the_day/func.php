...
$replace = db_quote('(?:promotions.company_id IN (?n) OR ?:promotions.company_id = ?i)', Tygh::$app['storefront']->getCompanyIds(), 0);
} else {
$replace = 1;
}
...
if (fn_allowed_for('MULTIVENDOR') && !empty($promotion['company_id'])) {
...
if (AREA === 'C' && !empty($promotion_data['storefront_ids'])) {
