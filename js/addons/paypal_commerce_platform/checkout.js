(function (_, $) {
  ...
  var methods = {
    ...
    getSmartButtonsLoadUrl: function getSmartButtonsLoadUrl(options) {
      var url = 'https://www.paypal.com/sdk/js' + '?client-id=' + options.clientId + '&currency=' + options.currency + '&debug=' + (options.debug ? 'true' : 'false') + '&intent=capture' + '&commit=true' + '&integration-date=2020-05-01' + '&merchant-id=' + (options.merchantIds.indexOf(',') === -1 ? options.merchantIds : '*');
