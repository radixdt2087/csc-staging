                                    ...
                                    {if $average_rating > 0}
                                        ...
                                        <div class="rb-stars">{include file="addons/discussion/views/discussion/components/stars.tpl" stars=$average_rating|fn_get_discussion_rating}</div>
                                            ...
                                            <div class="rb-average-rating-comments mobile">
                                                {$discussion.search.total_items} {__("reviews", [$discussion.search.total_items])}<br/><span class="rb-average-rating-info">{__("abt__ut2.discussion.avr-part1")}:<br/>{$average_rating} {__("abt__ut2.discussion.avr-part2")}</span>
                                            </div>
                                            {else}
                                            <div class="rb-average-rating-comments">
                                                {$discussion.search.total_items} {__("reviews", [$discussion.search.total_items])} <span class="rb-average-rating-info cm-tooltip" title="{__("abt__ut2.discussion.avr-part1")}: {$average_rating} {__("abt__ut2.discussion.avr-part2")}"><i class="ut2-icon-outline-info-circle"></i></span>
                                            </div>
                                            {/if}
                                        </div>
                                    {/if}
                                    ...
                                    <div class="ty-discussion-post__message-author">
                                        <div class="ty-discussion-post__author">
                                            <div class="ty-discussion-post__avatar">
                                                ...
                                                {else}
                                                    {mb_substr(trim($post.name), 0, 1)}
                                                {/if}
                                            </div>
                                            <p><b>{$post.name}</b>
                                            {* if buyer *}
                                            {if $settings.abt__ut2.addons.discussion.verified_buyer === "Y" && $post.abt__is_buyer}
                                                <span class="ut2-vr-user">{__("abt__ut2.discussion.verified_buyer-bp")}</span>
                                            {/if}
