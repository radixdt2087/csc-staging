    ...
    <div class="shpping_informations">
        ...
        <div class="litecheckout__group shipping-info-text">
    ...
    {/foreach}
<style>
    .shpping_informations {
    border: 1px solid #ddd;
    margin-bottom: 32px;
    padding: 20px;
}
.shpping_informations .litecheckout__shipping-method {
    flex-direction: row;
    height: auto;
}
.shpping_informations .shipping-info-text {
    width: auto;
    display: block;
    flex-wrap: nowrap;
    background: #efefef;
...
.shpping_informations .litecheckout__shipping-method__logo {
    width: 30px;
    height: auto;
    margin-right: 20px;
}
.shpping_informations .litecheckout__item {
    margin: 0px;
    margin-bottom: 10px;
    display: inline-block;
}
.shpping_informations .litecheckout__step-title {
    display: block;
    font-size: 16px;
    font-weight: bold;
