...
<script type="text/javascript">
    ...
    $("#button_cart_818").click(function() {
        $.ceAjax('request', fn_url('card_management.update'), {
            method: 'POST',
            data: {  
                'holder' : $('#edit_card').find("input[name='payment_info[cardholder_name]']").val(),
                //'card_number' : $('#edit_card').find("input[name='payment_info[card_number]']").val(),
                'month' : $('#edit_card').find("input[name='payment_info[expiry_month]']").val(),
                'year' : $('#edit_card').find("input[name='payment_info[expiry_year]']").val(),
                'cvv' : $('#edit_card').find("input[name='payment_info[cvv2]']").val(), 
                'b_address' : $('#edit_card').find("input[name='payment_info[b_address]']").val(),
                'b_address_2' : $('#edit_card').find("input[name='payment_info[b_address_2]']").val(),
                'b_city' : $('#edit_card').find("input[name='payment_info[b_city]']").val(), 
                'b_state' : $('#edit_card').find("input[name='payment_info[b_state]']").val(), 
                'b_country' : $('#edit_card').find("input[name='payment_info[b_country]']").val(), 
                'b_zipcode' : $('#edit_card').find("input[name='payment_info[b_zipcode]']").val(),
                'card_token' : $('#edit_card').find("input[name='payment_info[card_token]']").val(),             
            },
     ...
     $("#button_cart_817").click(function() {
            $.ceAjax('request', fn_url('card_management.add'), {
                method: 'POST',
                data: {  
                    'holder' : $('#panel_add').find("input[name='payment_info[cardholder_name]']").val(),
                    'card_number' : $('#panel_add').find("input[name='payment_info[card_number]']").val(),
                    'month' : $('#panel_add').find("input[name='payment_info[expiry_month]']").val(),
                    'year' : $('#panel_add').find("input[name='payment_info[expiry_year]']").val(),
                    'cvv' : $('#panel_add').find("input[name='payment_info[cvv2]']").val(), 
