...
<div id="savedDefaultCards">
    <div class="accordiondefault">
        <div class="card_name"> <input type="radio" name="payment_info[card_token]" value="{$defaultCard->data->id}" checked> {ucfirst($defaultCard->data->attributes->card->type)} card ending with {$defaultCard->data->attributes->card->number}</div>
        ...
        <div id="cardDetails">
            <div class="accordion">
                ...
                <input type="hidden" id="card_type{$item->data->id}" value="{$item->data->attributes->card->type}"/>
                    <!-- {implode("/",str_split($item->data->attributes->card->expiry,2))}              -->
            </div>
            <div class="panel">
                ...
                <!-- <div class="edit_card" id="edit_card" style="display: none;">
                    ...
                    <div class="row">
                        <div class="span6"><p><a class="cm-ajax cm-post cm-submit" href="{"card_management.setDefault?card_token={$item->data->id}"|fn_url}">Set as default</a> payment method.</p>
                        </div>
            ...
            <div class="clearfix">
                <div class="ty-credit-card cm-cc_form_{$id_suffix}">
                    ...
                    <div class="ty-credit-card__control-group ty-control-group">
                        ...
                        <!-- <input type="number" id="credit_card_month_{$id_suffix}" min="0" name="payment_info1[expiry_month]" value="" size="2" maxlength="2" class="ty-credit-card__input-short ty-inputmask-bdi" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>&nbsp;&nbsp;/&nbsp;&nbsp;<input type="number" min="0" id="credit_card_year_{$id_suffix}"  name="payment_info1[expiry_year]" value="" size="2" maxlength="2" class="ty-credit-card__input-short ty-inputmask-bdi" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>&nbsp; -->
                    </div>
                    <div class="ty-credit-card__control-group ty-control-group">
                        <label for="credit_card_name_{$id_suffix}" class="ty-control-group__title ">{__("cardholder_name")}</label>
...
<div class="edit_card position-data" id="edit_card" style="display: none;">
    <br>
    <h2 class="litecheckout__step-title">Edit your Card</h2>
    <div class="accordion">
         <div class="card_name" id="card_name"> 
           <!-- <input type="radio" name="payment_info[card_token]" value="{$item->data->id}"> {ucfirst($item->data->attributes->card->type)} card ending with {$item->data->attributes->card->number} -->
        </div>
    ...
    <div class="panel show">
        <div class="edit_card1 position-data" id="edit_card1" >
            ...
            <div class="row">
                <div class="span6 align-initial" style="vertical-align: baseline;"><input type="text" id="credit_card_name" name="payment_info[cardholder_name]" value="" class="cm-cc-name ty-credit-card__input ty-uppercase" /> <br>
                    ...
                    <div class="ty-credit-card__control-group ty-control-group">
                        ...
                        <input type="number" id="credit_card_month" min="0" name="payment_info[expiry_month]" value="" size="2" maxlength="2" class="ty-credit-card__input-short ty-inputmask-bdi" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>&nbsp;&nbsp;/&nbsp;&nbsp;<input type="number" min="0" id="credit_card_year"  name="payment_info[expiry_year]" value="" size="2" maxlength="2" class="ty-credit-card__input-short ty-inputmask-bdi" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>&nbsp;
                    </div>
                </div>
                <div class="span6 align-end"><input type="text" id="billing_address_line_1" name="payment_info[b_address]" value="" placeholder="Billing Address Line 1"/><br>
                    <input type="text" id="billing_address_line_2" name="payment_info[b_address_2]" value="" placeholder="Billing Address Line 2"/><br>
                    <input type="text" id="billing_city" name="payment_info[b_city]" value="" placeholder="City"/><br>
                    <input type="text" id="billing_state" name="payment_info[b_state]" value="" placeholder="State"/><br>
                    <input type="text" id="billing_country" name="payment_info[b_country]" value="" placeholder="Country"/> <input type="text" id="billing_zipcode" name="payment_info[b_zipcode]" value="" placeholder="Zipcode"/></div>
            </div>
            <div class="row">
                <div class="span6">
                    <div class="ty-control-group ty-credit-card__cvv-field cvv-field">
...
<script type="text/javascript">
    ...
    $(".button_cart_818").click(function() {
        $.ceAjax('request', fn_url('card_management.update'), {
            method: 'POST',
            data: {  
                'holder' : $('#edit_card1').find("input[name='payment_info[cardholder_name]']").val(),
                //'card_number' : $('#edit_card').find("input[name='payment_info[card_number]']").val(),
                'month' : $('#edit_card1').find("input[name='payment_info[expiry_month]']").val(),
                'year' : $('#edit_card1').find("input[name='payment_info[expiry_year]']").val(),
                'cvv' : $('#edit_card1').find("input[name='payment_info[cvv2]']").val(), 
                'b_address' : $('#edit_card1').find("input[name='payment_info[b_address]']").val(),
                'b_address_2' : $('#edit_card1').find("input[name='payment_info[b_address_2]']").val(),
                'b_city' : $('#edit_card1').find("input[name='payment_info[b_city]']").val(), 
                'b_state' : $('#edit_card1').find("input[name='payment_info[b_state]']").val(), 
                'b_country' : $('#edit_card1').find("input[name='payment_info[b_country]']").val(), 
                'b_zipcode' : $('#edit_card1').find("input[name='payment_info[b_zipcode]']").val(),
     ...
     $('.edit-btn').click(function() {
            ...
            $('#credit_card_month').val(exp_date[0]);
            $('#credit_card_year').val(exp_date[1]);
