...
{if $auth.user_id}
    ...
    <li class="ty-footer-menu__item"><a href="{"affiliate_plans.list"|fn_url}">{__("affiliates_partnership")}</a></li>
{else}
    ...
    <li class="ty-footer-menu__item"><a href="{"auth.login_form"|fn_url}"|fn_url}">{__("affiliates_partnership")}</a></li>
{/if}
