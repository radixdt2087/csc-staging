{script src="js/tygh/exceptions.js"}
 {if $aff_product}
 {$buy_url = "{$aff_product.BuyUrl}"|replace:'{subid}':"{$auth.user_id}"}
 <div class="ty-product-block ty-product-detail">
    <div class="ty-product-block__wrapper clearfix">
        <div class="ty-product-block__img-wrapper" style="width: {$settings.Thumbnails.product_details_thumbnail_width}px">
            <div class="ty-product-img cm-preview-wrapper sd-product-video">
                <img src="{$aff_product.Image}" loading="lazy"/>
            </div>
        </div>
        <div class="ty-product-block__left">
            <h1 class="ty-product-block-title"><bdi>{$aff_product.Name|replace:'�':'' nofilter}</bdi></h1>
            <div class="affiliate-description">{$aff_product.Description|strip_tags|replace:'&nbsp;':'.'}</div>
            <div class="prices-container price-wrap">
                <div class="ty-product-prices">
                    <div class="ty-product-block__price-actual ty-price-num">
                    {include file="common/price.tpl" value="{$aff_product.Price}"}
                    <p>*Actual price may vary. Select “Shop Direct” for updated product information</p>
                    </div>
                </div>
            </div>
            <div class="ty-product-block__button">
               <a class="ty-btn__primary ty-btn__big ty-btn__add-to-cart cm-form-dialog-closer ty-btn buy_now" url="{$buy_url}" >Shop Direct</a>
            </div>
        </div>
    </div>
</div>
