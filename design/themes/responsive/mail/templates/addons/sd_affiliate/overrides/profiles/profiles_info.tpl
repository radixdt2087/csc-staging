    ...
    <td valign="top">
        ...
        {if $settings.General.quick_registration == "Y"}
            <tr>
                ...
                <td>{if $user_data.company_id}{"?company_id=`$user_data.company_id`"|fn_url:"C"}{else}{""|fn_url:"C"}{/if}</td>
            </tr>
        {/if}
...
{if $user_data.user_type == 'P' && $settings.General.quick_registration == "Y"}
    {$profile_fields.C = ''}
{/if}
...
{/if}
{if ($profile_fields.B || $profile_fields.S) && $user_data.register_at_checkout != "Y" && !$settings.General.quick_registration == "Y"}
<tr>
    <td valign="top">
    {if $profile_fields.B}
        <p></p>
