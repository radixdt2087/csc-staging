...
<div class="ab_vg-images-wrapper clearfix" data-ca-previewer="true">
    ...
    <div style="position:relative;{if $settings.abt__device != "mobile"}{if $is_vertical && $total_count > 1}float:right;width:-webkit-calc(100% - {$smarty.capture.abt__ut2_vertical_gallery_width}px);width:calc(100% - {$smarty.capture.abt__ut2_vertical_gallery_width + 10}px);{if $image_height_block}max-height:{$image_height_block}px{/if}{elseif $image_height_block}max-height:{$image_height_block + 20}px{/if}{/if}">
