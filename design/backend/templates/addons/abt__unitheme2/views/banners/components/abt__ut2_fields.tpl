...
<div id="overlay_{$elm}" class="controls abt-ut2-overlay{if $disabled or $banner["`$elm`_use_own"] == 'N'} active{/if}">
<div id="elm_banner_{$elm}">
{include file="common/attach_images.tpl" image_name=$elm image_object_type="abt__ut2_banners" image_type="A" image_pair=$banner.$elm image_object_id=$id no_detailed=true hide_alt=true hide_titles=true}
</div>
</div>
</div>
