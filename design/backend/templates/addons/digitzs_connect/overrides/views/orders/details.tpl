    ...
    <div class="row-fluid">
        <div class="span8">
            ...
            <div class="table-responsive-wrapper">
                ...
                <thead>
                    <tr>
                        ...
                        {/if}
                        <th width="10%" class="center">&nbsp;{__("subtotal")}</th>
                        <!-- <th class="center" width="10%">Commission</th>
                        <th class="center" width="15%">Trans Fee</th>
                        <th class="right" width="10%">Profit*</th> -->
                    </tr>
                </thead>
                ...
                <tr>
                    ...
                    {/if}
                    <td class="center" data-th="{__("subtotal")}"><span>{if $oi.extra.exclude_from_calculate}{__("free")}{else}{include file="common/price.tpl" value=$oi.display_subtotal}{/if}</span></td>
                    <!-- <td class="center" data-th="Commission"><span>{$oi.wesave_commission}% + ${$oi.wesave_commission_amt}</span></td> 
                    <td class="center" data-th="Trans Fee"><span>${$oi.transaction_fee}</span></td>
                    <td class="right" data-th="Profit"><span>${$oi.display_subtotal-$oi.transaction_fee}</span></td>-->
                </tr>
                {/if}
                {/hook}
                {/foreach}
            ...
            <div class="trans">
                <div class="span6">
                    <table>
                        <tr><td><h5>WeSave Vendor Transaction Fee</h5></td></tr>
                    </table>
                </div>
                <div class="span6">
                    <table class="pull-right">
                        <tr><td><h5>Total Transaction Fee:</h5></td> <td class="right" style="color:red;">${$commission.commission_amount}</td></tr>
                        <tr><td><h4>Total profit:</h4></td> <td class="price right" data-ct-totals="total">
                            ${$order_info.display_subtotal-$commission.commission_amount}* 
                            
                        </td>
                    </tr>
                    </table>
                </div>
                <p class="right" style="background-color: #dcdcdc;">*Total profit excludes Merchant Account Processing fees.</p>
            </div>
    ...
    {/hook}
        ...
        <div class="span4">
            <div class="well orders-right-pane form-horizontal">
                    ...
                    {if $order_info.payment_info}
                        ...
                        <div class="control-group">
                            {if $item && $key != "expiry_year"}
                                ...
                                {if $key == "card_number"}{assign var="cc_exists" value=true}{__("credit_card")}{elseif $key == "card_numbers" || $key == "cvv" || $key == "cvv2" ||  $key == "expiry_month"}<div class="card" style="display: none;">{__($key)}</div>{else}{__($key)}{/if}
                                </div>
                                <div class="controls">
                                    {if $key == "order_status"}
                                    ...
                                    {elseif $key == "card_numbers" || $key == "cvv" || $key == "cvv2" || $key == "expiry_month"}
                                    <div class="wrap" style="display: none;">{$item}</div>
                                    {else}
                ...
                <!-- <div class="control-label">Accounting of Split :</div>
                {if $permission == 'admin'}

                    <div class="controls">
                        {$commission.commission_amount} out of {$commission.order_amount}
                    </div>

                {/if}
                {if $permission == 'access'}
                    <div class="controls">
                        {$vcommission} out of {$commission.order_amount}
                    </div>
