...
<div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="first_name" name="company_data[first_name]" size="32" value="{$vendor_details['first_name']}" class="input-large" >
        </div>
</div>
...
<div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="last_name" name="company_data[last_name]" size="32" value="{$vendor_details['last_name']}" class="input-large ">
        </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="day_phone" name="company_data[day_phone]" size="32" value="{$vendor_details['day_phone']}" class="input-large">
    </div>
</div>
...
<div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="business_name" name="company_data[business_name]" size="32" value="{$vendor_details['business_name']}" class="input-large ">
        </div>
</div>
<div class="control-group">
    <label class="control-label cm-required" for="url">Website URL</label>
    <div class="controls">
        <input type="text" id="url" name="company_data[url]" size="32" value="{$vendor_details['url']}" class="input-large ">
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="business_city" name="company_data[business_city]" size="32" value="{$vendor_details['business_city']}" class="input-large ">
    </div>
</div>
<div class="control-group">
    ...
    <div class="controls">
        ...
        <option value="USA" {if $vendor_details['business_country']=='USA'}selected{/if}>United States</option><option value="CAN" {if $vendor_details['business_country']=='CAN'}selected{/if}>Canada</option>
        </select>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="business_zipcode" name="company_data[business_zipcode]" size="32" maxlength="5" value="{$vendor_details['business_zipcode']}" class="input-large ">
    </div>
</div>
<div class="control-group">
