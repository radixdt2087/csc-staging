...
{capture name="tabsbox"}
    ...
    <div id="content_general" class="">
        ...
        <h4 class="subheader  ">LPO Details</h4>

        {if ("ULTIMATE"|fn_allowed_for || $user_type == "C")  && $id != $auth.user_id}
            {if $smarty.request.user_id}
                <div class="control-group">
                    <label for="password1" class="control-label">LPO Name:</label>
                    <div class="controls">
    ...
    <div id="content_general">
        ...
        {if ("ULTIMATE"|fn_allowed_for || $user_type == "C")  && $id != $auth.user_id}
            {if $smarty.request.user_id}
                <div class="control-group">
                    <label for="password1" class="control-label">Affiliate ID:</label>
                    <div class="controls">
                        <input type="text" class="input-large user-success clickTocopy" value="http://{$config.http_host}/index.php?dispatch=profiles.add&aff_id={$smarty.request.user_id}" readonly>
                    </div>
                </div>
            {/if}
        {/if}
