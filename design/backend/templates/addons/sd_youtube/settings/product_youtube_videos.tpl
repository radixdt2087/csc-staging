<div id="content_youtube_videos table-responsive-wrapper">
    ...
    {foreach from=$product_data.youtube_videos item="video" key="_key" name="prod_videos"}
        <tr class="cm-row-item">
            <td width="5%" class="{$no_hide_input_if_shared_product}" data-th="{__("position_short")}">
                <input type="text" name="product_data[youtube_videos][{$_key}][position]" value="{$video.position}" class="input-micro" />
    ...
    <tr class="{cycle values="table-row , " reset=1}{$no_hide_input_if_shared_product}" id="box_add_youtube_video">
        <td width="5%" data-th="{__("position_short")}">
            ...
            <input type="text" name="product_data[youtube_videos][{$new_key}][position]" value="" class="input-micro" />
