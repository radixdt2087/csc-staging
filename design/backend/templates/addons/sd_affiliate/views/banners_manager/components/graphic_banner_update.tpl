...
<div class="control-group">
    ...
    <div class="controls">
        {include "common/attach_images.tpl"
            image_name="banner"
            image_object_type="common"
            image_pair=$banner.main_pair
            image_object_id=$banner.banner_id
            hide_titles="Y"
            no_detailed="Y"
        }
    </div>
...
<div class="control-group">
    <label class="control-label" for="elm_aff_graphic_banner_width">{__("width")}&nbsp;({__("pixels")}){include file="common/tooltip.tpl" tooltip={__("addons.sd_affiliate.graphic_banner_height_width_tooltip")}}:</label>
    <div class="controls">
        <input type="text" name="banner[width]" id="elm_aff_graphic_banner_width" value="{$banner.width|default:"0"}" size="10" />
    </div>
</div>

<div class="control-group">
    <label class="control-label" for="elm_aff_graphic_banner_height">{__("height")}&nbsp;({__("pixels")}){include file="common/tooltip.tpl" tooltip={__("addons.sd_affiliate.graphic_banner_height_width_tooltip")}}:</label>
    <div class="controls">
        <input type="text" name="banner[height]" id="elm_aff_graphic_banner_height" value="{$banner.height|default:"0"}" size="10" />
    </div>
</div>
