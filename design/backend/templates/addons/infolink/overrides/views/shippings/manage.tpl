...
{if $shippings}
    <div id="shippings_content">
        ...
        <div class="shipping tabcontent">

            {assign var='videoLink' value='shipping_links'|fn_my_changes_get_upload_shippings:'shipping_links':'video'}
            {assign var='documentLink' value='shipping_links'|fn_my_changes_get_upload_shippings:'shipping_links':'document'}
            
            {if $videoLink != null || $documentLink != null}
                <h4>For guidance on how to add shipping methods please select a link below</h4>
            {/if}
