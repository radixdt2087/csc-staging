...
<div class="detailed tabcontent">
    {assign var='videoLink' value='product_manage_links'|fn_my_changes_get_upload_product_details:'product_manage_links':'video'}
    {assign var='documentLink' value='product_manage_links'|fn_my_changes_get_upload_product_details:'product_manage_links':'document'}
