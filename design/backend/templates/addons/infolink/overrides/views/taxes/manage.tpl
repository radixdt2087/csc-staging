...
<div class="taxes tabcontent">

    {assign var='videoLink' value='taxes_links'|fn_my_changes_get_upload_taxes:'taxes_links':'video'}
    {assign var='documentLink' value='taxes_links'|fn_my_changes_get_upload_taxes:'taxes_links':'document'}
    
    {if $videoLink != null || $documentLink != null}
        <h4>For guidance on how to add taxes please select a link below</h4>
    {/if}
