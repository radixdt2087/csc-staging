...
{include file="addons/infolink/infomenu.tpl"}
    ...
    <form action="su-admincenter.php?dispatch=infolink.info_upload" method="post" enctype="multipart/form-data" class="cm-processed-form">
        ...
        <input type="hidden" name="parentTab" value = "affiliate_links">
        <input type="hidden" name="tabName" value = "affiliate_links">
    ...
    {assign var='videoLink' value='affiliate_links'|fn_my_changes_get_upload_details_function:'affiliate_links':'video'}
    {assign var="documentLink" value='affiliate_links'|fn_my_changes_get_upload_details_function:'affiliate_links':'document'}
