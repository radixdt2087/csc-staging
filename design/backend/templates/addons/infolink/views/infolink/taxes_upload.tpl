...
{include file="addons/infolink/infomenu.tpl"}
    ...
    <form action="su-admincenter.php?dispatch=infolink.info_upload" method="post" enctype="multipart/form-data" class="cm-processed-form">
        ...
        <input type="hidden" name="parentTab" value = "taxes_links">
        <input type="hidden" name="tabName" value = "taxes_links">
    ...
    {assign var='videoLink' value='taxes_links'|fn_my_changes_get_upload_details_function:'taxes_links':'video'}
    {assign var="documentLink" value='taxes_links'|fn_my_changes_get_upload_details_function:'taxes_links':'document'}
