...
{include file="addons/infolink/infomenu.tpl"}
    ...
    <form action="su-admincenter.php?dispatch=infolink.info_upload" method="post" enctype="multipart/form-data" class="cm-processed-form">
        ...
        <input type="hidden" name="parentTab" value = "product_manage_links">
        <input type="hidden" name="tabName" value = "product_manage_links">
    ...
    {assign var='videoLink' value='product_manage_links'|fn_my_changes_get_upload_details_function:'product_manage_links':'video'}
    {assign var="documentLink" value='product_manage_links'|fn_my_changes_get_upload_details_function:'product_manage_links':'document'}
